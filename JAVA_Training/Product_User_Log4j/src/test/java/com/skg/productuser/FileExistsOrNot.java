...
public class FileExistsOrNot {
	...
	public static final String PRODUCTCSMAIN_FILENAME = "\\src\\main\\resources\\Product.csv";
	public static final String USERMAINCS_FILENAME = "\\src\\main\\resources\\User.csv";
