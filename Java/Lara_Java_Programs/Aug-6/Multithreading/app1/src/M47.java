class Shared 
{
	synchronized void test1()
	{
		...
		s{
			...
			//again relase the s1 and it ill b available for main available for main  
		}
	...
	synchronized void test2()
	{
		...
		notify();//once the notify is called the s1 obj is not released 
		//once main thread calls the notify it notify eighter A or B object
